...
const PopupUI3 = (props:any) => {
  ...
  const src = "https://fitforgrowth.id/growth_videocoach?u=cjE5b21HVFZjUFJSc1FYYi9adHJzbks2Ym1NMnRsVldVYm5tY2t0cGJCOD07bFlxV0EvVXRwNnlVdENtNFBxNzV6eVVlQTh2bGQxSjRaRzV4YzhRd2UvUT0l4iLa&mode="+props.mode
  ...
  return (
    <>
      <div 
        ...
        style={{display:popUpIndex===3?'block':'none', zIndex:2000000000}}
      >
